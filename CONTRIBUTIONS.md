...
## 1. Faiza Clara Vimanda

**NIM:** 102022400300
**Tanggung Jawab:** Appointment Service dan integrasi utama
...
* Melakukan pengujian end-to-end serta pengujian keamanan.

Commit utama:

* `be0343d` — Secure JWT SSO and integrate healthcare services.
* `02c13bf` — Complete patient and pharmacy end-to-end integration.

## 2. Tabitha Sirait

**NIM:** 102022400238
**Tanggung Jawab:** Data Pasien Service
...
* `93447ef` — Use service API key from Docker environment.

## 3. Muhammad Fadhlan S.

**NIM:** 102022400084
**Tanggung Jawab:** Farmasi dan Obat Service
...
* `993f45b` — Secure API key and validate integration fields.
